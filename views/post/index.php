...
<div class="news">
    <div class="col-md-8 news1">
        <div class="headline">
            ...
            <h1>Выровненный слева текст для экрана размера XL (extra-large) или более широкого.</h1></p>
        </div>
        <div class="text-news">
            <p class="text-left">Ambitioni dedisse scripsisse iudicaretur. Cras mattis iudicium purus sit amet
                fermentum.
...
<div class="row-3">
    <div class="col-md-4">
        <p class="text-xl-left">
        <h2>Выровненный слева текст для экрана размера XL </h2></p>
